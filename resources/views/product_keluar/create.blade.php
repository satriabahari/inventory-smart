    ...
    <section class="p-8">
        <div class="container mx-auto">
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
                ...
                <!-- Form -->
                <form action="{{ route('product_keluar.store') }}" method="POST" class="space-y-4">
                    @csrf
                    ...
                    <div class="grid grid-cols-[1fr_2fr] items-center">
                        ...
                        <input type="date" name="tanggal" id="tanggal" class="w-full border-gray-300 dark:bg-gray-700 dark:text-gray-50 bg-gray-100 rounded-md p-2" required>
                    </div>
