          ...
          <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
              ...
              <form action="{{ route('product.update', $data->id) }}" method="POST">
                  ...
                  <div class="mb-6">
                      ...
                      <input type="number" name="price" id="price" class="w-full border-gray-300 rounded-md p-2" required value="{{ $data->price }}">
                  </div>
  
                  <!-- Stock -->
                  <div class="mb-6">
                      <label for="stock" class="block text-gray-600 font-medium mb-2">Stock</label>
                      <input type="number" name="stock" id="stock" class="w-full border-gray-300 rounded-md p-2" required value="{{ $data->stock }}">
                  </div>
