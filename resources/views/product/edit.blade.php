    ...
    <section class="p-8">
        <div class="container mx-auto">
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
                <h1 class="text-2xl font-bold mb-8 text-gray-500 dark:text-gray-300">Edit Data Product</h1>
        
                <!-- Form -->
                <form action="{{ route('product.update', $data->id) }}" method="POST" class="space-y-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div class=" grid grid-cols-[1fr_2fr] items-center">
                        ...
                        <textarea name="description" id="description" class="w-full border-gray-300 dark:bg-gray-700 dark:text-gray-50 bg-gray-100 rounded-md p-2" rows="3" placeholder="Description" required>{{ $data->description }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-[1fr_2fr] items-center ">
                        ...
                        <input type="number" name="price" id="price" class="w-full border-gray-300 dark:bg-gray-700 dark:text-gray-50 bg-gray-100 rounded-md p-2" placeholder="Price" value="{{ $data->price }}" required>
                    </div>
