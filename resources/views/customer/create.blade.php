    ...
    <section class="p-8">
        <div class="container mx-auto">
            <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
                <h1 class="text-2xl font-bold mb-8 text-gray-500 dark:text-gray-300">Create Customer</h1>
                ...
                <form action="{{ route('customer.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="grid grid-cols-[1fr_2fr] items-center">
                        ...
                        <input type="text" name="name" id="name" class="w-full border-gray-300 dark:bg-gray-700 dark:text-gray-50 bg-gray-100 rounded-md p-2" placeholder="Name" required>
                    </div>
                    ...
                    <div class="grid grid-cols-[1fr_2fr] items-center">
                        ...
                        <input type="email" name="email" id="email" class="w-full border-gray-300 dark:bg-gray-700 dark:text-gray-50 bg-gray-100 rounded-md p-2" placeholder="Email" required>
                    </div>

                    <!-- Phone -->
                    <div class="grid grid-cols-[1fr_2fr] items-center">
                        <label for="phone" class="block text-gray-500 dark:text-gray-300 font-medium mb-2">Phone<x-star-required/></label>
                        <input type="tel" name="phone" id="phone" class="w-full border-gray-300 dark:bg-gray-700 dark:text-gray-50 bg-gray-100 rounded-md p-2" placeholder="Phone" required>
                    </div>
