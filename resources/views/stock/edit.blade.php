    ...
    @section("content")
        <form action="{{route("stock.update", $data->id)}}" method="POST">
            ...
            <div class="flex justify-between">
                ...
                <input type="text" name="name" id="name" class="rounded-lg py-2 px-4 outline-none bg-neutral-200" value={{$data->name}}>
            </div>

            <div class="flex justify-between">
                <label for="description" class="text-lg text-neutral-500">Description</label>
                <div>
                    <textarea name="description" id="description" cols="23" rows="5" class="rounded-lg py-2 px-4 outline-none bg-neutral-200">{{$data->description}}</textarea>
                </div>
            </div>
            ...
            <div class="flex justify-between">
                ...
                <div>
                    <textarea name="stock" id="stock" cols="23" rows="5" class="rounded-lg py-2 px-4 outline-none bg-neutral-200">{{$data->stock}}</textarea>
                </div>
            </div>
